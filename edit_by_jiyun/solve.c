...
/*   Updated: 2024/08/21 18:07:13 by jilee2           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	try_place(t_node *n, char c)
{
	...
	if ((is_duplicate_row(n) || is_duplicate_col(n) || is_check_colup(n) ||
		is_check_rowleft(n) || is_check_coldown(n) || is_check_rowright(n)))
	{
